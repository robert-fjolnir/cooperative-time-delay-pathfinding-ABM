...
to move
  ...
  set xc xc + step-size * dx * (communication-component + individual-weight * gradient-detected)
  set yc yc + step-size * dy * (communication-component + individual-weight * gradient-detected)
...
to sense-communications
  set communication-component 0.5
end
